...
import imagen3 from '../assets/images/3.jpg'; // Corregir la ruta relativa
      ...
      <div className="container container-main" style={containerStyle}>
        <div className="row">
          <div className="col-md-6">
            {/* Imagen del producto */}
            <img src={imagen3} className="product-image" alt="Nombre del producto" style={imageStyle} />
          </div>
          <div className="col-md-6">
            {/* Contenedor de detalles del producto */}
            <div className="product-details" style={productDetailsStyle}>
              <h2>TENIS STAN SMITH LUX</h2>
